...
"https://github.com/monun/team-spawn/releases/latest/download/TeamSpawn.jar",
"https://github.com/monun/block-trigger/releases/latest/download/BlockTrigger.jar",
"https://github.com/monun/delayed-respawn/releases/latest/download/DelayedRespawn.jar",
